...
<div class="block text-justify">
    <div>
        Conste en el presente contrato de {{ strtolower($title) }}, que al solo reconocimiento de firmas y rúbricas ante autoridad competente será elevado a Instrumento Público, por lo que las partes que intervienen lo suscriben al tenor de las siguientes cláusulas y condiciones:
    </div>
    <div>
    ...
    <div>
        ...
        <?php }
            ...
            <b>SEXTA.- (DE LA FORMA DE PAGO Y OTRAS CONTINGENCIAS):</b> Para el cumplimiento estricto de la obligación (capital e intereses) el PRESTATARIO, autoriza expresamente a MUSERPOL practicar los descuentos respectivos de {{$type_rent}} que percibe en forma mensual a través del {{ $quinta }}.
            <div>
    ...
    <div>
        <ol type="a">
            ...
            <li>Cumplir con el Contrato de Préstamo suscrito entre la MUSERPOL y el afiliado o viuda.</li>
...
<div class="block text-justify">
    ...
    <div>
        ...
        <?php }
            ...
            <b>QUINTA.- (DE LA FORMA DE PAGO Y OTRAS CONTINGENCIAS):</b> Para el cumplimiento estricto de la obligación (capital e intereses) el PRESTATARIO, autoriza expresamente a MUSERPOL practicar los descuentos respectivos de {{$type_rent}} que percibe en forma mensual a través del {{ $quinta }}.
            <div>
