...
class CreateViewLoanAmortizationsTable extends Migration
{
    ...
    public function up()
    {
        ...
        as select l.id as id_loan, l.code as code_loan, l.disbursement_date as disbursement_date_loan, l.amount_approved as amount_approved_loan, ptl.name as procedure_type_loan, li.annual_interest as annual_interest_loan, lp.state_affiliate as state_affiliate_loan_payment,
              ...
              lpc.name as name_category, lpc.shortened as shortened_category, lpc.type_register as type_register_category, v.payment_date  as payment_date_voucher, v.bank_pay_number as bank_pay_number_voucher, v.total as total_voucher, v.id as id_voucher, v.deleted_at as deleted_at_voucher
