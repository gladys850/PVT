...
class UpdateFunctionsLoansMoraData extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        AS $$
            begin
                ...
                (   select 
                        ...
                        -- BORROWER
                        ,vlb.registration_borrower, vlb.identity_card_borrower, vlb.city_exp_first_shortened_borrower, vlb.full_name_borrower, vlb.category_name, vlb.shortened_degree
